...
namespace MiniIMU
{
    public partial class Form1 : Form
    {
        ...
        private void toolStripButton2_Click_1(object sender, EventArgs e)
        {
            ...
            byteSend[8] = (byte)'S';
            if (SendMessage(byteSend) != 0) return;
            Status.Text = rm.GetString("Finish！");
        }
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            switch (iBaudNo)            
            {
                case 0:   
                    ...
                    break;
                case 1:
                    if (sRightPack > 2) {timer2.Stop();Status.Text = "Find Device";}
                    else
                    {
                        Baund = 4800;
                        SetBaudrate(Baund);
                ...
                case 10:
                    ...
                    {
                        timer2.Stop();
                        Status.Text = "Without Find Device！";
                    }
                    break;
            }
            iBaudNo = iBaudNo + 1;            
